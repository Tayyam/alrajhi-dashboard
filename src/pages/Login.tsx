  ...
  return (
    ...
    >
      <div className="w-full max-w-md bg-white/95 rounded-2xl shadow-xl p-8 backdrop-blur-sm" dir="rtl">
        ...
        <h1 className="text-2xl font-bold text-center text-[#334278] mb-2">
          تسجيل الدخول
        </h1>
        <p className="text-sm text-center text-gray-500 mb-8">
          الجدول الزمني لمهام مكاتب شؤون الحج
        </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-xl border border-gray-300 focus:border-[#334278] focus:ring-2 focus:ring-[#334278]/20 outline-none transition text-sm"
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3 rounded-xl bg-[#334278] text-white font-bold text-base hover:bg-[#253060] transition disabled:opacity-60 cursor-pointer"
          >
